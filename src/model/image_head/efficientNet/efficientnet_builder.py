...
import src.model.image_head.efficientNet.efficientnet_model as efficientnet_model
import src.model.image_head.efficientNet.utils as utils
...
def build_model_base(images, model_name, is_training, override_params=None):
  ...
  with tf.variable_scope(model_name):
    model = efficientnet_model.Model(blocks_args, global_params)
    features = model(images, training=is_training, features_only=False)
